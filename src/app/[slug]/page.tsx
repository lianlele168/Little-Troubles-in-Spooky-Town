  ...
  return (
    <>
      ...
      <section className="article-hero">
        {page.image ? <Image src={page.image} alt={page.imageAlt ?? "Little Troubles in Spooky Town gameplay"} fill priority sizes="100vw" className="object-cover object-center" /> : null}
          ...
          <article className="article-body">
            ...
            {page.slug === "updates" ? (
              <div className="source-links">
                ...
                <a href={site.officialTrailerUrl} target="_blank" rel="noopener noreferrer">Official trailer <ExternalLink className="h-4 w-4" /></a>
              </div>
            ) : null}
          </article>
