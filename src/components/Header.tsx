...
import { ArrowUpRight, ChevronRight, Ghost, Menu, Search, Sparkles, X } from "lucide-react";
    ...
    <>
      <header className="site-header">
        <div className="page-shell flex h-16 items-center justify-between gap-3">
          <Link href="/" className="brand-lockup" aria-label="Little Troubles Guide home">
            <span className="brand-mark"><Ghost className="h-5 w-5" /></span>
            <span className="min-w-0">
              <span className="brand-name">Little Troubles</span>
              <span className="brand-kicker">Spooky Town guide</span>
            </span>
          </Link>
